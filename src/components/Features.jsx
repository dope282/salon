const FEATURES = [
  { icon:'🏡', title:'Тав Тухтай Орчин', desc:'AMU MALL-н 6 давхарт байрлах тав тухтай цэвэр цэмцгэр орчинд үйлчлүүлээрэй.' },
  { icon:'👑', title:'Мэргэшсэн Артистууд', desc:'Чадварлаг туршлагатай артистууд таны онцлогт тохируулан ажиллана.' },
  { icon:'💎', title:'Premium Бүтээгдэхүүн', desc:'Дэлхийн шилдэг брэндүүд Lycon Wax, Estemax, Elleebana, Studex болон чанартай материал ашиглан аюулгүй үйлчилгээ үзүүлнэ.' },
  { icon:'⭐', title:'Үйлчлүүлэгчдийн итгэл', desc:'Чанар хариуцлага ур чадвараараа үйлчлүүлэгчдийнхээ итгэлийг хүлээсэн салон болно.' },
];
